...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">学校名 </span>
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>所在城市：</td>
								<td><select class="form-control" name="areaid" id = "areaid" aria-required="true" required>
							...
							<tr>
								<td>是否云营：</td>
								<td colspan="4">
									<input type="radio" id="status1" name="status" value="运营"
									class="form-control" aria-required="true" required/>运营
									<input type="radio" id="status2" name="status" value="禁用"
									class="form-control" aria-required="true" required/>禁用
								</td>
							</tr>
							<tr>
	...
	function initEditUser(getSelection){
		...
		var status=getSelection.status;
		if(status=="运营"){
			$("#status1").porp("checked",true)
		}else{
			$("#status2").porp("checked",true)
